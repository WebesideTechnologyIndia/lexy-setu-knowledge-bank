...
class RuleForm(forms.ModelForm):
    class Meta:
        model = Rule
        fields = ['chapter', 'name', 'full_name', 'rule_number', 'year', 
        ...
        widgets = {
            ...
            'name': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'e.g., Income Tax Rules'
            }),
            'full_name': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'Full name of the rule (optional)'
            }),
...
class RuleSectionForm(forms.ModelForm):
    class Meta:
        model = RuleSection
        fields = ['rule', 'parent_section', 'section_number', 'name', 'full_name',
        ...
        widgets = {
            ...
            'name': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'Enter rule section name'
            }),
            'full_name': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'Full rule section name (optional)'
            }),
            'content': CKEditorWidget(attrs={
                'class': 'form-control'
            }),
...
class SubRuleForm(forms.ModelForm):
    class Meta:
        model = SubRule
        fields = ['rule', 'section', 'subrule_number', 'name', 'content', 
        ...
        widgets = {
            ...
            'subrule_number': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'e.g., 1, 2A'
            }),
            'name': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'Enter sub-rule name'
            }),
            'content': CKEditorWidget(attrs={
                'class': 'form-control'
            }),
            'description': forms.Textarea(attrs={
                'class': 'form-control',
                'rows': 4,
                'placeholder': 'Sub-rule description'
            }),
            'amendments': forms.Textarea(attrs={
                'class': 'form-control',
                'rows': 4,
...
class FormForm(forms.ModelForm):
    class Meta:
        model = Form
        fields = ['rule', 'section', 'form_number', 'name', 'description', 
...
class NotificationForm(forms.ModelForm):
    class Meta:
        model = Notification
        fields = ['rule', 'notification_number', 'title', 'content', 'summary',
